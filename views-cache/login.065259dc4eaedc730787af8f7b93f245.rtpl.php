...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="http://www.projetosimonetti.com.br/simonettiadmin/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="http://www.projetosimonetti.com.br/admin/users"><b>Login</b>Simonetti</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Entre para iniciar sua sessão</p>

    <form action="http://www.projetosimonetti.com.br/admin/login" method="post">
    ...
    <a href="http://www.projetosimonetti.com.br/admin/forgot">Esqueci a minha senha</a><br>
...
<!-- jQuery 3 -->
<script src="http://www.projetosimonetti.com.br/simonettiadmin/bower_components/jquery/dist/jquery.min.js"></script>
<!-- Bootstrap 3.3.7 -->
<script src="http://www.projetosimonetti.com.br/simonettiadmin/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- iCheck -->
<script src="http://www.projetosimonetti.com.br/simonettiadmin/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
